 ...
 * @param {Array} iso3166.mobile_number_lengths - all available phone number lengths for this country
...
module.exports = function validatePhoneISO3166(phone, iso3166, allowLandline, plusSign) {
	...
	const isLengthValid = mobile_number_lengths.some(length => phoneWithoutCountry.length === length);
